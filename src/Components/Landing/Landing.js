        ...
        return (
            <div className="background container">
                <div className="welcome">
                    ...
                    <p className="gmail">Etch.rush@gmail.com</p>
                </div>
                <div className="about">
